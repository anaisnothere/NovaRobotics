...
@Autonomous(name="vorbesc serios")
@Disabled
public class maurasc extends LinearOpMode {
    ...
    ModernRoboticsI2cGyro   gyro    = null;              // Additional Gyro device
        ...
        static final double     COUNTS_PER_MOTOR_REV    = 1120 ;    // !!!!!PENTRU ANDYMARK
        ...
        public void gyroDrive ( double speed,
            ...
            if (opModeIsActive()) {
                ...
                newLeftTarget = robot.lfDrive.getCurrentPosition() + moveCounts;
                newLeftTarget = robot.lbDrive.getCurrentPosition() + moveCounts;
                newRightTarget = robot.rfDrive.getCurrentPosition() + moveCounts;
                newRightTarget = robot.rbDrive.getCurrentPosition() + moveCounts;
                ...
                robot.rfDrive.setTargetPosition(newRightTarget);
                ...
                while (opModeIsActive() &&
                        (robot.lbDrive.isBusy() && robot.lfDrive.isBusy() && robot.rfDrive.isBusy() && robot.rbDrive.isBusy())) {
                    ...
                    telemetry.addData("Actual",  "%7d:%7d",      robot.lbDrive.getCurrentPosition(),
                            robot.lfDrive.getCurrentPosition(), robot.rfDrive.getCurrentPosition(),
